...
public class AJTextBox extends JTextField {
    ...
    private void customizeComponent() {
        ...
        setForeground(AJAppStyle.COLOR_FONT_LIGHT);
        setCaretColor(AJAppStyle.COLOR_CURSOR); // Color del cursor
    ...
    public void setBorderRect() {
        Border lineBorder = BorderFactory.createLineBorder(AJAppStyle.COLOR_BORDER);
    ...
    private void setBorderDownLine() {
        ...
        setBorder(BorderFactory.createCompoundBorder(
                ...
                BorderFactory.createMatteBorder(0, 0, thickness, 0, AJAppStyle.COLOR_BORDER)));
    }
}
